...
This plot shows the positions of clicks in terms of the relative position through the path, which is the position of the link divided by the total length of the path.
</div>
