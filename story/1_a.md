...
Here we compute [HITS]({{ '/story/others/HITS.md' | relative_url }}) scores (hubs and authorities) and [PageRank]({{ '/story/others/PageRank.md' | relative_url }}) values for all pages in the Wikipedia graph.

The [HITS algorithm]({{ '/story/others/HITS.md' | relative_url }}) identifies two types of central nodes: hubs (pages pointing to many authoritative pages) and authorities (pages pointed to by many hubs). 
[PageRank]({{ '/story/others/PageRank.md' | relative_url }}) evaluates the overall importance of a page in the graph, taking into account both the quantity and quality of incoming links. 
...
<div class="alert-success">
[HITS]({{ '/story/others/HITS.md' | relative_url }}) confirms that the greatest authorities are geographical but the biggest hubs are lists. They don't contain a lot of information but acts like directories. "Driving_on_the_left_or_right" is certainly a list of countries is thus very powerful in wikispeedia.
</div>
...
In the [HITS algorithm]({{ '/story/others/HITS.md' | relative_url }}) page, the related [PageRank]({{ '/story/others/PageRank.md' | relative_url }}) is linked as another example.
